...
/**
 * Badge variants — pill-shaped status indicators.
 * Includes success and warning variants for richer feedback.
 */
...
/**
 * Status badge for labeling items with semantic color meaning.
 */
