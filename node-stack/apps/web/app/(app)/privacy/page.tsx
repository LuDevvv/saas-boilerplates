  ...
  return (
    <div className="container py-24">
      ...
      <div className="prose prose-blue max-w-none text-gray-600 space-y-6">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 mt-12">1. Information We Collect</h2>
        <p>
          We collect information you provide directly to us, such as when you join our waitlist or create an account.
        </p>
        <h2 className="text-2xl font-semibold text-gray-900 mt-12">2. How We Use Information</h2>
        <p>
