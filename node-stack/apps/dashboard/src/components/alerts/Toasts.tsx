    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className={`text-[13px] font-bold tracking-tight ${style.title}`}>
            {payload.title}
          </p>
          {payload.description && (
            <p className="mt-0.5 text-[12px] text-gray-500 dark:text-gray-400 font-medium leading-tight line-clamp-2">
              {payload.description}
            </p>
          )}
        </div>
