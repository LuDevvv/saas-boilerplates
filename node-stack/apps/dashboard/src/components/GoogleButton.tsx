...
const GoogleButton: React.FC<GoogleButtonProps> = ({
  ...
  const buttonText =
    type === "signin" ? "Continuar con Google" : "Registrarse con Google";
  ...
  return (
    ...
    >
      {isLoading ? (
        <svg
          className="size-5 animate-spin text-gray-600 dark:text-gray-300"
      ...
      <span>{isLoading ? "Procesando..." : buttonText}</span>
    </button>
  );
};
