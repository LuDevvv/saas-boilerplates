    ...
    <section className={cn("relative overflow-hidden py-24 lg:py-32 bg-background", className)}>
      <div className="container relative z-10 mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          <h1 
            ref={titleRef}
            className="max-w-4xl text-4xl font-extrabold tracking-tight text-foreground sm:text-6xl lg:text-7xl"
          >
            {title}
          </h1>
          <p 
          ...
          >
            <Button size="xl" onClick={onCtaClick} magnetic>
              {ctaText}
            </Button>
            <Button size="xl" variant="outline" magnetic>
              Learn More
            </Button>
          </div>
        </div>
