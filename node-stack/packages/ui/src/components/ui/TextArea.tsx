      ...
      >
        {label && (
          <label className="flex items-center justify-between px-1">
            <span
              className={cn(
                "text-[11px] font-label uppercase tracking-widest flex items-center gap-1.5 transition-colors duration-300",
                error
                  ? "text-[#EF4F5F]"
        ...
        <div className="relative">
          ...
          <textarea
            ...
            className={cn(
              "w-full pr-5 py-4",
              icon ? "pl-12" : "pl-5",
              "text-[14px] font-label text-[#0F172A] dark:text-[#F8FAFC]",              "bg-[#F8FAFC] dark:bg-[#0F172A]",
              "border border-[#E2E8F0] dark:border-[#FFFFFF]/5 rounded-2xl",
              ...
              error
                ...
                : "border-[#E2E8F0] dark:border-[#FFFFFF]/5 focus:border-[#004080] dark:focus:border-[#00E6E6]",
              className
            )}
            {...props}
          />
        ...
        {(error || helperText) && (
          <p
            className={cn(
              "px-1 text-[11px] font-label uppercase tracking-wider animate-in slide-in-from-top-1 duration-300",
