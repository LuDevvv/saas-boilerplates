    ...
    <div className={cn("group flex flex-col gap-1.5", className)}>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div
            className={cn(
              ...
              checked
                ? "bg-white dark:bg-gray-800 border-primary-500 shadow-primary-500/10 scale-100 active:scale-95"
                : "bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700 hover:border-primary-200 dark:hover:border-primary-800 scale-100 active:scale-95",
              error &&
          ...
          >
            ...
            <div
              className={cn(
                "w-2.5 h-2.5 rounded-full bg-primary-500 transition-all duration-300 transform",
                checked
      ...
      {(error || helperText) && (
        <div className="mt-0.5 px-1 ml-9">
          <p
            className={cn(
              "text-xs font-medium animate-in fade-in slide-in-from-left-1 duration-300",
