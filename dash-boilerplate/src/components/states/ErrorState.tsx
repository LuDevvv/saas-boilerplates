  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-4 py-16">
      <div className="bg-white dark:bg-gray-900 rounded-[3rem] shadow-premium p-12 max-w-md w-full text-center border border-gray-100 dark:border-gray-800 transition-all">
        ...
        <h2 className="text-3xl lg:text-3xl font-black text-gray-900 dark:text-white mb-4 tracking-tight">
          {title}
        </h2>
        ...
        {onRetry && (
          <button
            className="w-full flex items-center justify-center gap-2 bg-primary-500 text-white px-8 py-4 rounded-2xl font-black hover:bg-primary-600 transition-all shadow-lg shadow-primary-500/20 active:scale-95 group border border-primary-400"
            onClick={onRetry}
          >
