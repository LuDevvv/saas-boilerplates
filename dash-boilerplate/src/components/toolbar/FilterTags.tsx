        ...
        {tags.map((tag) => {
          ...
          return (
            <button
              ...
              className={cn(
                "shrink-0 px-4 py-1.5 rounded-full text-sm font-medium border transition-colors whitespace-nowrap active:scale-95 outline-none focus-visible:ring-2 focus-visible:ring-blue-500",
                isActive
