...
export type Variables = {
  ...
  permissions?: string[];
  /** Current billing plan for the active workspace */
  ...
  /** Injected service layer (Dependency Injection) */
  services: {
    db: import("@workspace/db").Database;
    cache: import("../services/cache.service").CacheService;
    queue: import("../services/queue.service").QueueService;
    email: import("../services/email.service").EmailService;
    auth: import("@workspace/services").AuthService;
    workspaces: import("@workspace/services").WorkspaceService;
