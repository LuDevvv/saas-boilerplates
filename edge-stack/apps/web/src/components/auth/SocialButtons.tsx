  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <Button
        ...
        disabled={!!isLoading}
        className="w-full h-12 rounded-xl border-input bg-background hover:bg-accent text-foreground font-bold text-sm shadow-sm transition-all duration-300 gap-2"
      >
        {isLoading === "google" ? (
